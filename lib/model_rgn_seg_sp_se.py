...
from lib.encoders_rgn_seg_sp_se import get_image_encoder, get_text_encoder
...
class VSegModel(object):
    ...
    def forward_emb(self, images, segmentations, cat_onehots, Unet_segs, captions, lengths, image_lengths=None):
        ...
        if self.opt.precomp_enc_type == 'basic':
            if torch.cuda.is_available():
                ...
                Unet_segs = Unet_segs.cuda()
                cat_onehots = cat_onehots.cuda()
                
            img_emb = self.img_enc(images, segmentations, cat_onehots, Unet_segs, image_lengths)
        else:
            if torch.cuda.is_available():
                images = images.cuda()
                captions = captions.cuda()
...
#                 segmentations= segmentations.cuda()
            ...
            img_emb = self.img_enc(images, segmentations, Unet_segs)
    ...
    def train_emb(self, images, segmentations, cat_onehots, Unet_segs, captions, lengths, image_lengths=None, warmup_alpha=None):
        ...
        img_emb, cap_emb = self.forward_emb(images, segmentations, cat_onehots, Unet_segs, captions, lengths, image_lengths=image_lengths)
